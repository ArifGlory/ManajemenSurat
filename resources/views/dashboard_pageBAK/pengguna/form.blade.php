                                                    ...
                                                    <div class="my-5" data-wizard-type="step-content">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select
                                                                    class="form-control select_sm  @error('level') is-invalid @enderror"
                                                                    name="level" id="level">
                                                        ...
                                                        <!--begin::Group-->
                                                        <div class="form-group row" style="display: none" id="opdTugas">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select
                                                                    class="form-control select_sm  @error('active') is-invalid @enderror"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    class="form-control @error('username') is-invalid @enderror form-control-sm"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    class="form-control @error('password') is-invalid @enderror form-control-sm"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    class="form-control @error('password_confirmation') is-invalid @enderror form-control-sm"
