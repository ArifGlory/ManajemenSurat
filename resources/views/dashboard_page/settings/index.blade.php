                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input
                                                    class="form-control @error('setting_Value') is-invalid @enderror form-control-sm"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                ...
                                                <textarea id="{{$i->setting_Key}}" name="setting_Value[]" rows="3"
                                                          class="form-control @error('setting_Value') is-invalid @enderror form-control-sm">{{$i->setting_Value}}</textarea>
                                                @error('setting_Value')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
