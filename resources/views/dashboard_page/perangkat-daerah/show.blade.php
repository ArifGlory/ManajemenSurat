...
@section('title', 'Detail Pejabat / Perangkat Daerah')
@push('library-css')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Detail Pejabat / Perangkat Daerah</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    ...
                                    <label class="col-sm-1 col-lg-1 col-form-label">:</label>
                                    <label class="col-sm-6 col-lg-6 col-form-label font-weight-bolder">
                                        <div class="{{getActive($active)}} text-small font-600-bold"><i class="fas fa-circle"></i> {{getActiveTeks($active)}}</div>
                                    </label>
                                </div>
                            </div>
                            <hr class="mb-2">
                        ...
                        <div class="card-body">
                            <div class="empty-state">
                                <img class="img-fluid"
                                     ...
                                     alt="image">
                                <h2 class="mt-0 mb-2">Data Pejabat / Perangkat Daerah</h2>
                                @if (count($errors) > 0)
