...
<head>
    ...
    <meta name="description" content="Aplikasi Manajemen Surat" />
    <meta name="keywords" content="Aplikasi Manajemen Surat" />
    <meta name="author" content="Arif Glory" />
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" class="form-control @error('username') is-invalid @enderror" placeholder="Username anda" name="username" required="">
                                            @error('username')
